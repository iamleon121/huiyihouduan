    ...
    if (fileParam) {
        ...
        if (pageNum > 0) {
            ...
            pageInfoElement.style.cssText = `
                ...
                margin-bottom: 10px;
            `;
            pageInfoElement.textContent = `总页数: ${pageNum}`;
            document.getElementById('fileContent').appendChild(pageInfoElement);
        }
                ...
                plus.io.resolveLocalFileSystemURL(filePath, function(entry) {
                    ...
                    entry.file(function(file) {
                        ...
                        reader.onloadend = function(e) {
                            ...
                            let pageInfoHtml = '';
                            if (pageNum > 0) {
                                pageInfoHtml = `<div style="text-align: right; padding: 5px 10px; color: #666; font-size: 14px; background-color: #f5f5f5; border-radius: 4px; margin-bottom: 10px;">总页数: ${pageNum}</div>`;
                            }
                            
                            fileContent.innerHTML = `${pageInfoHtml}<img src="${e.target.result}" style="width: 100%; height: auto; display: block; margin: 0; padding: 0;">`;
                        };
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (pageSelect) {
        ...
        pageSelect.addEventListener('change', function() {
            document.getElementById('currentPage').textContent = this.value;
        });
    }
